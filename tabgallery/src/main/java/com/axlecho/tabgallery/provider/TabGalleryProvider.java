...
import com.axlecho.tabgallery.spider.SpiderQueen;
...
public class TabGalleryProvider extends GalleryProvider2 implements SpiderQueen.OnSpiderListener {
    ...
    public TabGalleryProvider(Context context, ImageTabInfo galleryInfo) {
        mContext = context;
